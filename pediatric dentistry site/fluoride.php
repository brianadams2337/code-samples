	...
	<div id="containerMain">
		...
		<div id="contentMain" class="container">
			...
			<article class="main full left">
				...
				<p>Topical application applied directly to the teeth to provide protection to the tooth from dental decay; this treatment is recommended twice a year directly after the dental cleaning/prophylaxis.</p>
			</article>
			<div class="lineDotted left">&nbsp;</div>
			<aside class="main full left">
				<h3>What are the benefits?</h3>
				<div class="columns">
					<p>The use of fluoride, both in systemic dosages and topical applications, is recommended by the American Dental Association, the American Medical Association, the American Academy of Pediatric Dentistry, the American Academy of Pediatric Medicine, the National Institutes of Health and every dental school in the United States. Fluoride combats tooth decay in two ways.</p>
					<p>It is incorporated into the structure of developing teeth when it is ingested and also works when it comes in contact with the surface of the teeth. Fluoride prevents the acid produced by the bacteria in plaque from dissolving or demineralizing tooth enamel, the hard and shiny substance that protects the teeth. Fluoride also allows teeth damaged by acid to repair or remineralize themselves. Fluoride cannot repair cavities, but it can reverse low levels of tooth decay and thus prevent new cavities from forming. If your child is not getting enough fluoride internally through water (especially if the fluoride level is deficient or if your child drinks bottled water without fluoride), then fluoride supplements might need to be prescribed.</p>
				</div>
			</aside>
			<div class="lineDotted left">&nbsp;</div>
			<aside class="main full left">
